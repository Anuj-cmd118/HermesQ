...
void PN532_SPI::begin()
{
    ...
    // Modern SPI API: SPISettings replaces setDataMode/setBitOrder/setClockDivider.
    // PN532 requires SPI_MODE0, LSBFIRST, max 5 MHz — 2 MHz is a safe choice.
...
void PN532_SPI::writeFrame(const uint8_t *header, uint8_t hlen, const uint8_t *body, uint8_t blen)
{
    ...
    write(~sum + 1);        // checksum of TFI + DATA
